		...
		<>
			<div className="accordion-item bg-transparent text-white">
				<h2 className="accordion-header" id={`panelsStayOpen-heading-${toggleNum}`}>
					<button className="accordion-button shadow-none bg-transparent text-white" type="button" data-bs-toggle="collapse" data-bs-target={`#panelsStayOpen-collapse-${toggleNum}`} aria-expanded="true" aria-controls={`panelsStayOpen-collapse-${toggleNum}`}>
